...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        'overflow-hidden p-1 text-foreground **:[[cmdk-group-heading]]:px-22***:[[cmdk-group-heading]]:py-1.55**:[[cmdk-group-heading]]:text-xss **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group-heading]]:text-muted-foreground',
        className,
      )}
      {...props}
    />
