...
import {
  ...
  useResourceDelete,
  useResourceUpdate,
} from '../../services/resource.mutation';
import { useResourceDetails } from '../../services/resource.queries';
...
export default function ResourceCRUD({ defaultMode, id }: ResourceCRUDProps) {
  ...
  /* READ */
  const read = useResourceDetails(id!, {
    enabled: !!id,
  });
